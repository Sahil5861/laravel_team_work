...
class DealersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('dealers')->insert([
            ...
            [
                'business_name' => 'Gamma Enterprises',
                'business_email' => 'gamma@enterprises.com',
            ...
            [
                'business_name' => 'Epsilon Technologies',
                'business_email' => 'epsilon@tech.com',
            ...
            [
                'business_name' => 'Theta Manufacturing',
                'business_email' => 'theta@manufacturing.com',
