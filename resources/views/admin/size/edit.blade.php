                ...
                <div class="page-header-content d-lg-flex">
                    <div class="d-flex">
                        <h4 class="page-title mb-0">
                            Dashboard - <span class="fw-normal">Edit Size</span>
                        </h4>
                    </div>
                </div>
            </div>
            ...
            <div class="content">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title fw-bold">Edit Size</h5>
                    </div>
                    <div class="card-body">
                        @if($errors->any())
                        ...
                        <form action="{{ route('admin.size.edit.post', $size->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="short_name" id="short_name" class="form-control" value="{{ $size->short_name }}">
                            </div>
                            <div class="mb-3">
