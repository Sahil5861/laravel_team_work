                ...
                <div class="page-header-content d-lg-flex">
                    <div class="d-flex">
                        <h4 class="page-title mb-0">
                            Dashboard - <span class="fw-normal">Categories</span>
                        </h4>
                        <a href="#page_header"
                        ...
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                ...
                                <div class="hstack gap-2 ms-auto">
                                    <a href="{{route('admin.category')}}" class="text-dark btn btn-dark">Back</a>                
                                </div>
                            </div>
                            <div class="collapse show">
                                <div class="card-body">
                                    <form action="{{route('admin.category.create.post')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row mb-3">
                                            <div class="col-lg-6">
