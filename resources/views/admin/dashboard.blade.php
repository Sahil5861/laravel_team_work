                                ...
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="d-block me-3">
                                                        <img src="{{asset('assets/images/brands/facebook.svg')}}"
                                            ...
                                            <td><span class="text-success"><i class="ph-trend-up me-2"></i> 2.43%</span>
                                            </td>
                                            <td>
                                                <h6 class="mb-0">$5,489</h6>
                                            </td>
                                            <td><span class="badge bg-primary bg-opacity-10 text-primary">Active</span>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="d-block me-3">
                                                        <img src="{{asset('assets/images/brands/youtube.svg')}}"
                                                            class="rounded-circle" width="36" height="36" alt="">
                                                    </a>
                                                    <div>
                                            ...
                                            <td><span class="text-success"><i class="ph-trend-up me-2"></i> 3.12%</span>
                                            </td>
                                            <td>
                                                <h6 class="mb-0">$2,592</h6>
                                            </td>
                                            <td><span class="badge bg-danger bg-opacity-10 text-danger">Closed</span>
                                            </td>
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    <a href="#" class="text-body" data-bs-toggle="dropdown">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="d-block me-3">
                                                        <img src="{{asset('assets/images/brands/spotify.svg')}}"
                                                            class="rounded-circle" width="36" height="36" alt="">
                                                    </a>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="d-block me-3">
                                                        <img src="{{asset('assets/images/brands/twitter.svg')}}"
                                                            class="rounded-circle" width="36" height="36" alt="">
                                                    </a>
                                                    <div>
                                            ...
                                            <td><span class="text-success"><i class="ph-trend-up me-2"></i> 2.78%</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="d-block me-3">
                                                        <img src="{{asset('assets/images/brands/bing.svg')}}"
                                                            class="rounded-circle" width="36" height="36" alt="">
                                                    </a>
                                                    <div>
                                            ...
                                            <td><span class="badge bg-success bg-opacity-10 text-success">Pending</span>
                                            </td>
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    <a href="#" class="text-body" data-bs-toggle="dropdown">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="d-block me-3">
                                                        <img src="{{asset('assets/images/brands/amazon.svg')}}"
                                                            class="rounded-circle" width="36" height="36" alt="">
                                                    </a>
                                                    <div>
                                            ...
                                            <td><span class="text-success"><i class="ph-trend-up me-2"></i> 6.79%</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="d-block me-3">
                                                        <img src="{{asset('assets/images/brands/dribbble.svg')}}"
                                                            class="rounded-circle" width="36" height="36" alt="">
                                                    </a>
                                                    <div>
                                ...
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <a href="#" class="text-body">
                                                    <div class="fw-semibold">[#1183] Workaround for OS X selects
                                                        printing bug</div>
                                                    <span class="text-muted">Chrome fixed the bug several versions ago,
                                                        thus rendering this...</span>
                                                </a>
                                            </td>
                                            <td class="text-center">
                                                <div class="dropdown">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="d-inline-block me-3">
                                                        <img src="{{asset('assets/images/demo/users/face15.jpg')}}"
                                            ...
                                            <td>
                                                <a href="#" class="text-body">
                                                    <div class="fw-semibold">[#1249] Vertically center carousel controls
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="text-body">
                                                    <div class="fw-semibold">[#1254] Inaccurate small pagination height
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="text-body">
                                                    <div class="fw-semibold">[#1184] Round grid column gutter operations
                                                    </div>
                                                    <span class="text-muted">Left rounds up, right rounds down. should
                                                        keep everything...</span>
                                                </a>
                                            </td>
                                            <td class="text-center">
                                                <div class="dropdown">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="text-body">
                                                    ...
                                                    <span class="text-muted">Rather than building a string of HTML and
                                                        then parsing it...</span>
                                                </a>
                                            </td>
                                            <td class="text-center">
                                                <div class="dropdown">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="d-inline-block me-3">
                                                        <img src="{{asset('assets/images/demo/users/face8.jpg')}}"
                                                            class="rounded-circle" width="40" height="40" alt="">
                                                    </a>
                                                    <div>
                            ...
                            <div class="card-body pb-0">
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="d-sm-flex align-items-sm-start mb-3">
                                            <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                                <img src="{{asset('assets/images/demo/flat/1.png')}}"
                                        ...
                                        <div class="d-sm-flex align-items-sm-start mb-3">
                                            <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                                <img src="{{asset('assets/images/demo/flat/21.png')}}"
                                                    class="flex-shrink-0 rounded" height="100" alt="">
                                                <div
                                                    class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                                    <i class="ph-play"></i>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="d-sm-flex align-items-sm-start mb-3">
                                            <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                                <img src="{{asset('assets/images/demo/flat/12.png')}}"
                                                    class="flex-shrink-0 rounded" height="100" alt="">
                                                <div
                                                    class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                                    <i class="ph-play"></i>
                                        ...
                                        <div class="d-sm-flex align-items-sm-start mb-3">
                                            <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                                <img src="{{asset('assets/images/demo/flat/18.png')}}"
                                                    class="flex-shrink-0 rounded" height="100" alt="">
                                                <div
                                                    class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                                    <i class="ph-play"></i>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="d-inline-block me-3">
                                                        <img src="{{asset('assets/images/demo/logos/1.svg')}}" alt=""
                                                            height="36">
                                                    </a>
                                                    <div>
                                                        <a href="#"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="d-inline-block me-3">
                                                        <img src="{{asset('assets/images/demo/logos/2.svg')}}" alt=""
                                                            height="36">
                                                    </a>
                                                    <div>
                                                        <a href="#"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="d-inline-block me-3">
                                                        <img src="{{asset('assets/images/demo/logos/3.svg')}}" alt=""
                                                            height="36">
                                                    </a>
                                                    <div>
                                                        <a href="#"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="d-inline-block me-3">
                                                        <img src="{{asset('assets/images/demo/logos/4.svg')}}" alt=""
                                                            height="36">
                                                    </a>
                                                    <div>
                                                        <a href="#"
                        ...
                        <div class="card">
                            ...
                            <div class="tab-content card-body">
                                ...
                                <div class="tab-pane fade" id="messages-mon">
                                    <div class="d-flex align-items-start mb-3">
                                        <div class="status-indicator-container me-3">
                                            <img src="{{asset('assets/images/demo/users/face2.jpg')}}"
                                                class="rounded-circle" width="40" height="40" alt="">
                                            <span class="status-indicator bg-success"></span>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-start mb-3">
                                        <div class="status-indicator-container me-3">
                                            <img src="{{asset('assets/images/demo/users/face7.jpg')}}"
                                                class="rounded-circle" width="40" height="40" alt="">
                                    ...
                                    <div class="d-flex align-items-start mb-3">
                                        <div class="status-indicator-container me-3">
                                            <img src="{{asset('assets/images/demo/users/face18.jpg')}}"
                                                class="rounded-circle" width="40" height="40" alt="">
                                            <span class="status-indicator bg-warning"></span>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-start mb-3">
                                        <div class="status-indicator-container me-3">
                                            <img src="{{asset('assets/images/demo/users/face14.jpg')}}"
                                                class="rounded-circle" width="40" height="40" alt="">
                                            <span class="status-indicator bg-success"></span>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="messages-fri">
                                    ...
                                    <div class="d-flex align-items-start mb-3">
                                        <div class="status-indicator-container me-3">
                                            <img src="{{asset('assets/images/demo/users/face12.jpg')}}"
                                                class="rounded-circle" width="40" height="40" alt="">
                                            <span class="status-indicator bg-warning"></span>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-start mb-3">
                                        <div class="status-indicator-container me-3">
                                            <img src="{{asset('assets/images/demo/users/face22.jpg')}}"
                                                class="rounded-circle" width="40" height="40" alt="">
                                            <span class="status-indicator bg-danger"></span>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-start">
                                        <div class="status-indicator-container me-3">
                                            <img src="{{asset('assets/images/demo/users/face17.jpg')}}"
                                                class="rounded-circle" width="40" height="40" alt="">
                                            <span class="status-indicator bg-secondary"></span>
                                        </div>
